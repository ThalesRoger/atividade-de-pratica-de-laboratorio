                    ...
                    <div class="">
                        <div class="p-6">
                            <div class="flex items-center">
                                <img src="{{asset('img/titulacao.gif')}}" width="100" height="100" alt="Logo do experimento" />
                                <div class="ml-4 text-lg leading-7 font-semibold"><h3>Titulação</h3></div>
                            </div>

                            <div>
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    A titulação é uma técnica usada para determinar a quantidade de uma substância em uma amostra usando uma solução de concentração conhecida, essa técnica também é chamada de análise volumétrica. Uma das aplicações do método de titulação é na verificação se a quantidade de um composto químico está de acordo com o indicado na embalagem do produto. 
O tipo de análise volumétrica mais conhecida é a titulação ácido-base, que utiliza indicadores de pH para determinar o ponto final da titulação, o que significa que toda a amostra reagiu com o volume da solução padrão adicionada.
Clique aqui para ser direcionado para página de titulação ácido-base
